...
namespace 雪莉轻食
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            int a = 0;
            int b = 0;
            DataTable objDataTable = DBHelper.GetDataTable("select * from  TheOrderTable a inner join OrderStateTable b on a.OrderNumber=b.OrderNumber where b.OrderState='派送完成'");
