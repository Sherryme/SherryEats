use master
-------------------------------创建SherryEats数据库-----------------------------------
if exists(select * from sysdatabases where name='SherryEatsDB')
drop database SherryEatsDB
go
create database SherryEatsDB
on(
name='SherryEatsDB',
filename='E:\SherryEatsDB.mdf',
size=5,
filegrowth=10%
)
log on(
name='SherryEatsDB_log',
filename='E:\SherryEatsDB.ldf',
size=5,
filegrowth=10%
)
---------------------------------------------------------------------------------
...
select '雅乐轩妈妈菜','二堰街道水云间城市花园路口雅乐轩酒店10楼','13692396325',2,'雅乐轩妈妈菜.jpg','  ','标题.png' ,'正餐优选'union
select '小香莲','张湾区开源路八中旁二楼','13692396325',2,'小香莲.jpg','  ' ,'标题.png','下午茶' union
select '农家小厨','柳林路卫生监督局旁','13692566325',2,'农家小厨.jpg','  ','标题.png' ,'下午茶' union
select '全全零食屋','茅箭区车站北路9号桃源御品1期2号楼负1层4、5号商铺','13692589525',2,'全全零食屋.jpg','  ','标题.png','超市' union
select '花为美鲜花','茅箭区东岳路34号1楼1-1号','13698526925',2,'花为美鲜花.jpeg','  ','标题.png' ,'超市' union
select '北京片皮鸭','平顶山市湛河区北渡镇35号','13698789525',2,'北京片皮鸭.jpg','  ','标题.png','精选小吃'  union
select '来益香水果店','平顶山市茅箭区南岳路大臣批发市场7栋15号','13698785215',2,'来益香水果店.jpg','  ','标题.png' ,'鲜果购' union
select '賖店老酒','平顶山市朝阳路258号','13698125615',2,'賖店老酒.jpg','  ' ,'标题.png','下午茶' union
select '365精品水果汇','平顶山市五堰街朝阳路1号 十堰国际金融中心附近','13678925615',2,'365精品水果汇.jpg','  ' ,'标题.png','鲜果购'union
select '百乐汇生活超市','五堰街办柳林路46号','13698185465',2,'百乐汇生活超市.jpg','  ' ,'标题.png','超市'union
select '西域贡果新疆特产','天津路88号大洋五洲一期C区8号商铺','15798185465',2,'西域贡果新疆特产.jpg','  ','标题.png','精选小吃' union
select '小李子油焖大虾','开源路15-3号','13692587465',2,'小李子油焖大虾.jpg','  ' ,'标题.png','精选小吃' union
select '俞小厨红虾馆','开源路188号','13692852465',2,'俞小厨红虾馆.jpg','  ' ,'标题.png','精选小吃'
go
